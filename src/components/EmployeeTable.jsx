...
const EmployeeTable = ({ updateEmployee, deleteEmployee }) => {
          ...
          {employees.length > 0 ? (
            employees.map((employee) => (
              ...
              >
                  ...
                  <div className="flex items-center text-sm">
                    <div className="relative w-8 h-8 mr-3 rounded-full md:block">
                      <img
                        ...
                        src={employee.profilePicture || Avatar}
                        alt=""
                        loading="lazy"
                      />
                      <div
                ...
                <td className="px-4 py-3 text-sm">{employee.employeePhone}</td>
                <td className="px-4 py-3 text-sm">{employee.employeeEmail}</td>
